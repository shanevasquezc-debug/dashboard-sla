...
bts_data = pd.DataFrame([
    ...
    {"Torrera": "Telecommunications Partners","T_Busqueda": 63,  "T_Saneamiento": 87,  "T_Construccion": 42,  "T_Total": 192, "N_Sitios": 9},
])
...
ct_data = pd.DataFrame([
    ...
    {"Torrera": "Telecommunications Partners","T_Factibilidad": 10, "T_ValidacionAP": 11, "T_Inicio": 2,  "T_FinObra": 13, "T_Total": 36,  "N_Sitios": 1},
])
...
dev_data = pd.DataFrame([
    ...
    {"Torrera": "Telecommunications Partners", "N_Devoluciones": 11},
...
<div style="background:{DARK};padding:1rem 1.5rem;border-radius:12px;
  ...
  <span style="color:rgba(255,255,255,.4);font-size:12px;margin-left:auto">
    Solo estados FNE + LPE · 92 proyectos</span>
</div>
""", unsafe_allow_html=True)
...
exec_items = [
    ...
    ("✅", "Finalizados FNE+LPE", "92", "Proyectos completados", C3),
]
...
rank_df = pd.DataFrame([
    ...
    {"Torrera": "Telecommunications Partners", "BTS": 192, "CT": 36},
...
st.markdown(f'<p style="text-align:center;color:#7A83A6;font-size:11px;margin-top:1rem">Dashboard SLA 2026 · Solo estados FNE + LPE · 92 proyectos</p>', unsafe_allow_html=True)
